...
class TypKolorystyczny(models.Model):
    ...
    dominujaca_tonacja = models.CharField(max_length=20)  # ciepła/zimna
    poziom_kontrastu = models.CharField(max_length=20)  # niski/średni/wysoki
    nasycenie = models.CharField(max_length=20)  # miękkie/czyste/głębokie
    kolory_podstawowe = models.JSONField(default=list)  # lista hex kolorów
...
class Analiza(models.Model):
    ...
    tonacja_skory = models.CharField(max_length=20, blank=True)  # ciepła/zimna/neutralna
    kontrast_poziom = models.IntegerField(null=True, blank=True)  # 1-10
    nasycenie_poziom = models.IntegerField(null=True, blank=True)  # 1-10
    
    # Dane kolorów dominujących
    ...
    pewnosc_wyniku = models.FloatField(null=True, blank=True)  # 0-1
